...
<html lang="en">
	<head>
		...
		<!--"<?php echo e(URL::to('fonts/font-awesome.min.css')); ?>">
			...
			<header class="site-header">
				<div class="container">
					...
					<div class="main-navigation">
						...
						<ul class="menu">
							<li class="menu-item"><a href="<?php echo e(route("logged_in")); ?>">Home</a></li>
							<li class="menu-item current-menu-item">
							
							<li class="menu-item"><a href='<?php echo e(route('review')); ?>'>Movie reviews</a></li>
							<li class="menu-item"><a href="<?php echo e(route("joinus")); ?>">Join us</a></li>
							<li class="menu-item"><a href="<?php echo e(route("contact")); ?>">Contact</a></li>
						</ul> <!-- .menu -->
			...
			<main class="main-content">
				<div class="container">
					<div class="page">
						...
						<div class="row">
							<div class="col-md-4">
								<figure><img src="<?php echo e(URL::to("dummy/figure.jpg")); ?>" alt="figure image"></figure>
							</div>
							<div class="col-md-8">
						...
						<div class="row">
							...
							<div class="col-md-3">
								<div class="team">
									<figure class="team-image"><img src="<?php echo e(URL::to("dummy/person-1.jpg")); ?>" alt=""></figure>
							...
							<div class="col-md-3">
								<div class="team">
									<figure class="team-image"><img src="<?php echo e(URL::to("dummy/person-2.jpg")); ?>" alt=""></figure>
							...
							<div class="col-md-3">
								<div class="team">
									<figure class="team-image"><img src="<?php echo e(URL::to("dummy/person-3.jpg")); ?>" alt=""></figure>
							...
							<div class="col-md-3">
								<div class="team">
									<figure class="team-image"><img src="<?php echo e(URL::to("dummy/person-4.jpg")); ?>" alt=""></figure>
									<h2 class="team-name">Sarah Stuart</h2>
