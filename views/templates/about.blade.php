...
<html lang="en">
	<head>
		...
		<!--"{{ URL::to('fonts/font-awesome.min.css') }}">
			...
			<header class="site-header">
				<div class="container">
					...
					<div class="main-navigation">
						...
						<ul class="menu">
							<li class="menu-item"><a href="{{ route("logged_in")}}">Home</a></li>
				...
				<div class="container">
					<div class="page">
						<div class="breadcrumbs">
							<a href="{{route("logged_in")}}">Home</a>
							<span>About us</span>
						</div>

						<div class="row">
							<div class="col-md-4">
								<figure><img src="{{ URL::to("dummy/figure.jpg") }}" alt="figure image"></figure>
							</div>
							<div class="col-md-8">
						...
						<div class="row">
							...
							<div class="col-md-3">
								<div class="team">
									<figure class="team-image"><img src="{{ URL::to("dummy/person-1.jpg") }}" alt=""></figure>
							...
							<div class="col-md-3">
								<div class="team">
									<figure class="team-image"><img src="{{ URL::to("dummy/person-2.jpg") }}" alt=""></figure>
							...
							<div class="col-md-3">
								<div class="team">
									<figure class="team-image"><img src="{{ URL::to("dummy/person-3.jpg") }}" alt=""></figure>
							...
							<div class="col-md-3">
								<div class="team">
									<figure class="team-image"><img src="{{ URL::to("dummy/person-4.jpg") }}" alt=""></figure>
									<h2 class="team-name">Sarah Stuart</h2>
