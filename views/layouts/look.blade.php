        ...
        <div class="container">
            ...
            <div class="main-navigation">
                ...
                <ul class="menu">
                    ...
                    <li class="menu-item"><a href='{{ route('logged_in') }}'
                        >Home</a></li>
                    <li class="menu-item"><a href='{{ route('about') }}'
                        >About</a></li>
                    <li class="menu-item current-menu-item"><a href='{{ route('review') }}'
                        >Movie reviews</a></li>
                    <li class="menu-item"><a href='{{ route('joinus') }}'
                        >Join us</a></li>
            ...
            <div class="page">
                ...
                <div class="movie-list">
                    ...
                    <div class="movie">
                        ...
                        <div class="movie-title" value="{{ $movie->text }}"><a href="single.html">The adventure of Tintin</a></div>
                        <p>Sed ut perspiciatis unde omnis iste natus error voluptatem doloremque.</p>
                    </div>
                    <div class="movie">
